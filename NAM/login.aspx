<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="NAM.login" %>
            ...
            <form>
                ...
                <div class="con">
                    ...
                    <div class="field-set">
                        ...
                        <!-- buttons -->
                        <!-- button LogIn -->
                        <button class="log-in" runat="server" id="logIn_Btn">Logga In </button>
                    </div>
                    <!-- other buttons -->
                    <div class="other">
                        <!-- Forgot Password button-->
                        <button runat="server" id="forgotPass_Btn" class="btn submits frgt-pass">
                            Glömt lösenord
                            <i class="fa fa-question" aria-hidden="true"></i>
                        </button>
                        <!--Sign Up button -->
                        <button runat="server" id="signUp_Btn" class="btn submits sign-up">
                            Skapa ett konto 
                            <!--Sign Up font icon -->
